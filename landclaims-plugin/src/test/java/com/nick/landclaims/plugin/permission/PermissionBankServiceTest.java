...
class PermissionBankServiceTest {
    ...
    void registersFlagEditGroupsWithPerFlagChildren() {
        ...
        configuration.set("landclaims.flag.edit.basic", java.util.List.of("build", "break"));
        ...
        assertThat(permissions.getAllValues())
                .anySatisfy(permission -> {
                    assertThat(permission.getName()).isEqualTo("landclaims.flag.build");
                    assertThat(permission.getDefault()).isEqualTo(PermissionDefault.TRUE);
                })
                .anySatisfy(permission -> {
                    assertThat(permission.getName()).isEqualTo("landclaims.flag.edit.basic");
                    assertThat(permission.getChildren()).containsEntry("landclaims.flag.build", true);
                    assertThat(permission.getChildren()).containsEntry("landclaims.flag.break", true);
                });
    }
}
